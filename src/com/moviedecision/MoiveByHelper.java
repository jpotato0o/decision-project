...
import com.majorhelper.decision.InfluenceDiagram.Decision;

import smile.Network;

public class MoiveByHelper {
	private Network net;
...
//    }
    ...
    public MoiveByHelper(Map<String,String[]> parameterMap) {
        net = new Network();
        ...
        String xdslFileOut = (new File("models/modelOut.xdsl")).toString();
